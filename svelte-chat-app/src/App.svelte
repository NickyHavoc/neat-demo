<script>
	...
	async function fetchEntryMessage() {
		try {
			const entryMessage = { message: "Hey, how can I help you?", sender: "bot" };
			messages = [entryMessage];
		} catch (error) {
			console.error("Error fetching entry message:", error);
		}
	}
